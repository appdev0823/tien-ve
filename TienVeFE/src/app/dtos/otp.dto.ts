...
export class OtpDTO {
    ...
    public type: ValueOf<typeof CONSTANTS.LOGIN_TYPES> = CONSTANTS.LOGIN_TYPES.EMAIL;
    public expired_date = '';
    ...
    constructor(params?: Partial<OtpDTO>) {
        ...
        this.type = params?.type || CONSTANTS.LOGIN_TYPES.EMAIL;
    ...
    static fromJson(json?: { [key: string]: any }) {
        return new OtpDTO({
            ...
            type: json?.['type'] || CONSTANTS.LOGIN_TYPES.EMAIL,
